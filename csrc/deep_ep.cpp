...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    pybind11::class_<deep_ep::Buffer>(m, "Buffer")
        ...
        .def("get_dispatch_layout_async", &deep_ep::Buffer::get_dispatch_layout_async)
        .def("intranode_dispatch", &deep_ep::Buffer::intranode_dispatch)
        .def("intranode_dispatch_async", &deep_ep::Buffer::intranode_dispatch_async)
        .def("intranode_combine", &deep_ep::Buffer::intranode_combine)
        .def("intranode_combine_async", &deep_ep::Buffer::intranode_combine_async)
        .def("internode_dispatch", &deep_ep::Buffer::internode_dispatch)
        .def("internode_dispatch_async", &deep_ep::Buffer::internode_dispatch_async)
        .def("internode_combine", &deep_ep::Buffer::internode_combine)
        .def("internode_combine_async", &deep_ep::Buffer::internode_combine_async)
        .def("clean_low_latency_buffer", &deep_ep::Buffer::clean_low_latency_buffer)
        .def("low_latency_dispatch", &deep_ep::Buffer::low_latency_dispatch)
        .def("low_latency_dispatch_async", &deep_ep::Buffer::low_latency_dispatch_async)
        .def("low_latency_combine", &deep_ep::Buffer::low_latency_combine)
        .def("low_latency_combine_async", &deep_ep::Buffer::low_latency_combine_async)
